...
function Profile() {
  ...
  return (
    <>
      ...
      <div className="mt-10 flex justify-center items-start h-screen w-screen"> {/* Ocupa toda la pantalla y centra el contenido horizontalmente */}
        {user ? (
          <div className="mt-10 flex flex-col items-center mt-4"> {/* Centra la imagen y el texto */}
            <img
