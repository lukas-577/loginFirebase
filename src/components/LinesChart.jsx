...
export default function LinesChart({ dataFav }) {
    ...
    const labelColor = isDark ? '#fff' : '#000'; // Color de la leyenda (etiqueta "Icap")
    ...
    const options = {
        scales: {
            y: {
                beginAtZero: true,
                ticks: {
                    color: isDark ? '#fff' : '#000', // Color de los ticks del eje Y
                },
            },
            x: {
                ticks: {
                    color: isDark ? '#fff' : '#000', // Color de los ticks del eje X
                },
            },
        },
        plugins: {
